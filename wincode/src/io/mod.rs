...
pub trait Writer {
    ...
    /// Perform any cleanup or flushing of the writer.
    ///
    /// Be advised that this may be called on trusted [`Writer`] variants for subsections of the writer,
    /// so make sure that those implementations don't perform any cleanup operations that would
